...
#include <fdm/utils/fdm_EulerRect.h>
...
// max error due to T_STEP for 1st order method ( 10^-2 )^1 = 10^-2
#define DELTA_MAX 1.0e-2
...
/**
 * @brief The EulerRectTest class, a fdm::EulerRect integrator unit test class.
 *
 * Linear homogeneous ordinary differential (Cauchy–Euler) equation is used to
 * test EulerRect numerical integration class. Results obtained using a
 * fdm::EulerRect are going to be compared with results of differential equation
 * analytical solution.
 *
 ...
 * x'( 0 )  =  C_1 * a  +  C_2 * b
 *
 * @see Krysicki W., Wlodarski L.: Analiza matematyczna w zadaniach. PWN, Ed. XXVII, 2018 [in Polish], p.287
 */
class EulerRectTest : public QObject
{
    Q_OBJECT
...
bool EulerRectTest::solve( double m,
                           double k,
                           double c,
                           double x_0,
                           double x_1 )
{
    ...
    Integrator *integrator = new Integrator( this, &EulerRectTest::computeStateDeriv );
...
EulerRectTest::EulerRectTest() {}

////////////////////////////////////////////////////////////////////////////////

void EulerRectTest::initTestCase() {}

////////////////////////////////////////////////////////////////////////////////

void EulerRectTest::cleanupTestCase() {}
...
QTEST_APPLESS_MAIN(EulerRectTest)

////////////////////////////////////////////////////////////////////////////////

#include "test_fdm_eulerrect.moc"
